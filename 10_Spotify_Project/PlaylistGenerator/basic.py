...
parser.add_argument("-p", type=str, default="songs for cloudy cold days", help="The prompt to describe the playlist")
    ...
    messages = [
        {
            ...
            Your should return a JSON array, where each element follows this format: 
...
print("Created Playlist: " + str(created_playlist))
